        ...
        <div>
            <div>
                ...
                {faveWorkout.map((arm, index) => (
                    <article>
                        <h5 className='mt-16 text-center text-2xl font-perm text-red-200' key='first'>{arm.title}</h5>

                        <h5 className='text-center text-lg font-mono font-mono text-red-200' key='first'>{arm.description}</h5>

                        <h5 className='mt-8 ml-8 mr-8 text-center text-base mb-16 font-hyeon font-perm text-red-200' key='first'>{arm.list}</h5>
