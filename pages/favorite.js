        ...
        <div>
            <div>
                ...
                {faveWorkout.map((arm, index) => (
                    <article>
                        <h5 key={arm.title} className='mt-16 text-center text-2xl font-perm text-red-200'></h5>

                        <h5 key={arm.description} className='text-center text-lg font-mono font-mono text-red-200'></h5>

                        <h5 key={arm.list} className='mt-8 ml-8 mr-8 text-center text-base mb-16 font-hyeon font-perm text-red-200'></h5>
