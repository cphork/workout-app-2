...
const Favorite = ({ faveWorkout, deleteFaveWorkout }) => {
    ...
    const loaded = () => (
        <div>
            <div>
                <h2 className='text-center text-2xl mt-16 font-perm text-green-200'>Favorite Arms Workouts List</h2>
    ...
    const loading = () => (
        <div className='text-align'>
            <div>
                <h2 className='text-center text-2xl mb-48 mt-16 font-perm text-green-200'>Favorite Arms Workouts List</h2>
