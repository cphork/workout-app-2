...
import Arms from '../../public/bwarms.jpg';
import Legs from '../../public/bwlegs.jpg';
import Glutes from '../../public/bwglutes.jpg';
import Curls from '../../public/curlscropped.jpg';
...
export default function Home() {
    ...
    return (
        <>
            ...
            {/* <Image class='bg-curls' width='230' height='420' src={Curls} alt='curls' /> */}
            ...
            <div className='lg:flex'>
                ...
                <div className="hidden lg:flex justify-center max-w-md mx-auto bg-green-500 w-96 mt-16 lg:mt-4 rounded-xl overflow-hidden md:max-w-2xl">
                    <div className="md:flex">
                        <div className="md:flex-shrink-0">
            ...
            <h2 className='uppercase text-center mt-32 font-perm text-m lg:text-2xl text-green-200'>Click Below To Start!</h2>

            {/* ARMS IMAGE */}
            <div className='lg:flex'>
                <div className="lg:mr-8 lg:ml-8 lg:mt-16 mt-8 mb-16 ml-4 mr-4 group-hover:text-gray-900 rounded-xl overflow-hidden md:max-w-2xl">
                    <div>
                        <div className="md:flex-shrink-0">
                            <Link href='/arms'>
                        ...
                        <div className="lg:hover:bg-green-700 p-8 bg-green-200">
                            ...
                            <p className="block mt-1 text-lg leading-tight font-medium text-black hover:underline text-center">Learn Techniques To Target Your <strong className='text-red-500'>Arms</strong></p>
                ...
                <div className="lg:mr-8 mt-16 mb-16 ml-4 mr-4 group-hover:text-gray-900 rounded-xl overflow-hidden md:max-w-2xl">
                    <div>
                        <div className="md:flex-shrink-0">
                            <Link href='/legs'>
                                <a><Image className="h-48 w-full object-cover md:h-full md:w-48 shadow-xl" src={Legs} alt="Man looking at item at a store" /></a>
                            </Link>
                        </div>
                        <div className="lg:hover:bg-green-700 p-8 bg-green-200">
                            <div className="lg:hidden uppercase tracking-wide text-sm text-black font-semibold text-center">Click Me</div>
                            {/* <div className="uppercase tracking-wide text-sm text-indigo-500 font-semibold text-center">Legs Workout</div> */}
                            <p className="block mt-1 text-lg leading-tight font-medium text-black hover:underline text-center">Power Through These <strong className='text-red-500'>Leg</strong> Workouts</p>
                            {/* <p className="mt-2 text-gray-500">Getting a new business off the ground is a lot of hard work. Here are five ideas you can use to find your first customers.</p> */}
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:mr-8 mt-16 mb-16 ml-4 mr-4 rounded-xl overflow-hidden md:max-w-2xl">
                    <div>
                        ...
                        <div className="lg:hover:bg-green-700 p-8 bg-green-200">
                            ...
                            <p className="block mt-1 text-lg leading-tight font-medium text-black hover:underline text-center">Burn Your <strong className='text-red-500'>Glutes</strong> For Tighter Buns!</p>
                            {/* <p className="mt-2 text-gray-500">Getting a new business off the ground is a lot of hard work. Here are five ideas you can use to find your first customers.</p> */}
                        </div>
                    </div>
                </div>
            ...
            <p className='font-perm text-center text-2xl text-green-200 underline'>Fitness Blogs</p>
            <a href='https://www.nerdfitness.com/blog/' target="_blank" rel="noopener noreferrer" ><h1 className='underline text-center text-white font-mono mt-4'>Nerd Fitness</h1></a>
            <a href='https://lovesweatfitness.com/blog/' target="_blank" rel="noopener noreferrer"><h1 className='underline text-center text-white font-mono mt-4'>Love Sweat Fitness</h1></a>
            <a href='https://breakingmuscle.com/' target="_blank" rel="noopener noreferrer"><h1 className='underline text-center text-white font-mono mt-4'>Breaking Muscles</h1></a>
            <a href='https://www.reebok.com/us/blog?SSAID=314743&cm_mmc=Rbkaffiliates_SAS-_-314743-_-None-_-banner-_-dv%3AeCom-_-cn%3A450685-_-pc%3ANone&cm_mmc1=US&cm_mmc2=reebok-NA-eCom-Affiliates-314743-None-None-US-450685-None&dclid=CjkKEQjw8cCGBhCvz_fn4fTZ49wBEiQA_OrQTHKFeNas5Oyl2xTWg18EaqhQbGXhYl1SXfubE0dBlx3w_wcB&sscid=61k5_sqpes' target="_blank" rel="noopener noreferrer"><h1 className='underline text-center mb-16 text-white font-mono mt-4'>Reebok Fitness Blog</h1></a>
        </>
    )
}
